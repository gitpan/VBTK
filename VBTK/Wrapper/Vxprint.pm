...
#
#              $Source: /usr/local/cvsroot/vbtk/VBTK/Wrapper/Vxprint.pm,v $
#            $Revision: 1.4 $
...
#                       proper settings necessary to run a Veritas volume manager
#                       vxprint command.
#
...
#
#       $Log: Vxprint.pm,v $
#       Revision 1.4  2002/02/13 07:36:14  bhenry
#       Disabled RrdLogRecovery and removed use of @log
#
#       Revision 1.3  2002/01/26 06:14:28  bhenry
#       Changed to inherit from VBTK::Wrapper
#
...
defaults to simplify the setup of a 'vxprint' monitoring process.
...
=item $o = new VBTK::Wrapper::Vxprint (<parm1> => <val1>, <parm2> => <val2>, ...)

This method calls 'new L<VBTK::Wrapper|VBTK::Wrapper>' after defaulting
the parameters to best monitor the 'vxprint' command.  For a detailed description
